...
- generic, flexible code instead of autogenerated code
...
3. Create the `Entity.swift` file and declear the properties and relationships.
...
#### MastodonAsset
SwiftGen powered assets package.
...
The localized strings are now maintained by hand, with translations provided from CrowdIn. See `Documentation/CONTRIBUTING.md`.
